...
maa2c = marl.algos.maa2c(hyperparam_source="gobigger")
# build agent model based on env + algorithms + user preference
model = marl.build_model(env, maa2c, {"core_arch": "mlp", "encode_layer": "128-256"})
# start training
maa2c.fit(env, model, stop={"timesteps_total": 1000000}, checkpoint_freq=100, local_mode=False, num_gpus=0, num_workers=10, share_policy="group")
